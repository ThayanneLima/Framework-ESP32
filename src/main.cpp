...
void setup() {
  ...
  //pinMode(13,OUTPUT);
  //digitalWrite(13,LOW);
  //pinMode(PIN_LORA_TX, OUTPUT);  // Configura o pino como saída
  //digitalWrite(PIN_LORA_TX, LOW);  // Garante que começa desligado
...
// Colocando o ESP32 em deep sleep por 15 segundos
//Serial.println("Entrando em Deep Sleep...");
//esp_sleep_enable_timer_wakeup(SLEEP_TIME);
